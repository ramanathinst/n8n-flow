...
export const BorderLoadingIndicator = ({
    ...
    return (
        <>
            <div className={cn("absolute -top-px -left-px h-[calc(100%+4px)] w-[calc(100%+4px)]", className)}>
                <style>
                    {`
        @keyframes spin {
...
const StatusBorder = ({
    ...
    return (
        <>
            <div
                className={cn(
                    "absolute -top-px -left-px h-[calc(100%+4px)] w-[calc(100%+4px)] rounded-[9px] border-4",
                    className,
                )}
            />
            {children}
